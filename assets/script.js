...
const i18n = {
  en: {
    ...
    exp_binokular_4: "Fine‑tuned Qwen3‑0.6B (Indonesian summaries)",
    exp_binokular_5: "Resource efficiency via quantization/distillation; OCR + CV (OpenCV/YOLO) for audience analytics.",
    exp_binokular_6: "Sentiment API in production (gRPC, monitoring/logging).",
  ...
  id: {
    ...
    exp_binokular_6: "Sentiment API production (gRPC, monitoring/logging).",
